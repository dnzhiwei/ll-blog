  ...
  return (
    <div className="space-y-2">
      ...
      <input
        ...
        className="w-full px-3 py-2 bg-pal-dark border border-pal-border rounded-lg text-pal-text placeholder-pal-text-muted focus:border-pal-accent transition-colors duration-200"
        placeholder="请输入值"
        step={inputStep}
        min={min}
        max={max}
